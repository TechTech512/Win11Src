...
typedef enum _WDFFUNCENUM {
    ...
    WdfDeviceGetAlignmentRequirementTableIndex = 274,
    WdfDeviceSetAlignmentRequirementTableIndex = 275,
    WdfDmaEnablerCreateTableIndex = 276,
    WdfDmaEnablerGetMaximumLengthTableIndex = 277,
    WdfDmaEnablerGetMaximumScatterGatherElementsTableIndex = 278,
    WdfDmaEnablerSetMaximumScatterGatherElementsTableIndex = 279,
    WdfDmaEnablerGetFragmentLengthTableIndex = 280,
    WdfCommonBufferCreateTableIndex = 281,
    WdfCommonBufferCreateWithConfigTableIndex = 282,
    WdfCommonBufferGetAlignedVirtualAddressTableIndex = 283,
    WdfCommonBufferGetAlignedLogicalAddressTableIndex = 284,
    WdfCommonBufferGetLengthTableIndex = 285,
    WdfFdoQueryForInterfaceTableIndex = 286,
    WdfFunctionTableNumEntries = 287,
} WDFFUNCENUM;
...
typedef enum _WDFSTRUCTENUM {
    ...
    INDEX_WDF_DMA_ENABLER_CONFIG                       = 78,
    INDEX_WDF_COMMON_BUFFER_CONFIG                     = 79,
