...
//
// MessageId: STATUS_WDF_UMDF_DMA_NOT_SUPPORTED
//
// MessageText:
//
// The system does not meet the requirement for a UMDF device driver to do Direct Memory Access (DMA).
//
#define STATUS_WDF_UMDF_DMA_NOT_SUPPORTED ((NTSTATUS)0xC0200215L)
