...
MessageId= SymbolicName=HELP_BOOTCFG_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_DISKPART_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_DRIVERQUERY_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_EVENTQUERY_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_FSUTIL_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_GPRESULT_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_ICACLS_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_MKLINK_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_OPENFILES_HELP_MESSAGE
Language=English
OPENFILES      Displays files opened by remote users for a file share.
.

MessageId= SymbolicName=HELP_PAGEFILECONFIG_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_ROBOCOPY_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_SC_HELP_MESSAGE
Language=English
SC             Displays or configures services (background processes).
.

MessageId= SymbolicName=HELP_SCHTASKS_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_SHUTDOWN_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_SYSTEMINFO_HELP_MESSAGE
Language=English
SYSTEMINFO     Displays machine specific properties and configuration.
.

MessageId= SymbolicName=HELP_TASKLIST_HELP_MESSAGE
Language=English
TASKLIST       Displays all currently running tasks including services.
.

MessageId= SymbolicName=HELP_TASKKILL_HELP_MESSAGE
Language=English
...
MessageId= SymbolicName=HELP_WMIC_HELP_MESSAGE
Language=English
WMIC           Displays WMI information inside interactive command shell.
.

MessageId= SymbolicName=HELP_FOOTER_MESSAGE
Language=English
...
;#define HELP_LAST_HELP_MESSAGE HELP_FOOTER_MESSAGE
