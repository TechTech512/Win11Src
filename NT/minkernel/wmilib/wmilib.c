...
NTSTATUS WmiSystemControl(PWMILIB_CONTEXT WmiLibContext, PDEVICE_OBJECT DeviceObject, PIRP Irp, PSYSCTL_IRP_DISPOSITION IrpDisposition);
...
// Driver entry point (wmilib.sys is a library, not a real driver)
