...
NTSTATUS
NTAPI
BtrfsRecFsControl(IN PDEVICE_OBJECT DeviceObject,
                    IN PIRP Irp);
					
NTSTATUS
NTAPI
FfsRecFsControl(IN PDEVICE_OBJECT DeviceObject,
                    IN PIRP Irp);

NTSTATUS
NTAPI
ReiserfsRecFsControl(IN PDEVICE_OBJECT DeviceObject,
                    IN PIRP Irp);

NTSTATUS
NTAPI
ExtRecFsControl(IN PDEVICE_OBJECT DeviceObject,
                  IN PIRP Irp);

NTSTATUS
NTAPI
FatxRecFsControl(IN PDEVICE_OBJECT DeviceObject,
                   IN PIRP Irp);
