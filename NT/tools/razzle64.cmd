...
if not exist onecore\base\mvdm\dos\v86\cmd\command\chs\buildmsg.bat (
  copy tools\tools16\buildmsg_thunk.bat onecore\base\mvdm\dos\v86\cmd\command\chs\buildmsg.bat
)
if not exist onecore\base\mvdm\dos\v86\cmd\command\cht\buildmsg.bat (
  copy tools\tools16\buildmsg_thunk.bat onecore\base\mvdm\dos\v86\cmd\command\cht\buildmsg.bat
)
if not exist onecore\base\mvdm\dos\v86\cmd\command\jpn\buildmsg.bat (
  copy tools\tools16\buildmsg_thunk.bat onecore\base\mvdm\dos\v86\cmd\command\jpn\buildmsg.bat
)
if not exist base\mvdm\dos\v86\cmd\command\kor\buildmsg.bat (
  copy tools\tools16\buildmsg_thunk.bat onecore\base\mvdm\dos\v86\cmd\command\kor\buildmsg.bat
)
if not exist base\mvdm\dos\v86\cmd\command\usa\buildmsg.bat (
  copy tools\tools16\buildmsg_thunk.bat onecore\base\mvdm\dos\v86\cmd\command\usa\buildmsg.bat
)
popd
