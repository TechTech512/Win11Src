...
!ifndef SHARED_PATH
SHARED_PATH = $(BASEDIR)\onecore\external\shared
!endif

!ifndef SHARED_INC_PATH
SHARED_INC_PATH = $(SHARED_PATH)\inc
!endif
...
!ifndef UCRT_INC_PATH
UCRT_INC_PATH = $(SDK_INC_PATH)\ucrt
!endif
...
!ifndef STL17_INC_PATH
STL17_INC_PATH = $(SDK_INC_PATH)\crt\stl170
!endif
...
!ifndef PUBLIC_PRIVATE_PATH
PUBLIC_PRIVATE_PATH = $(BASEDIR)\public\private
!endif
...
PROJECT_ROOT=$(BASEDIR)\onecore\$(_PROJECT_)
