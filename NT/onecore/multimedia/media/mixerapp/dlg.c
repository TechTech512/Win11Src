    ...
    DWORD   *pcbNew)
{
    ...
    DLGTEMPLATE * lpdtDst = NULL;
    DLGTEMPLATE * lpdtAdd = NULL;    
    DLGTEMPLATE2 * lpdtDst2 = NULL;
    DLGTEMPLATE2 * lpdtAdd2 = NULL;    
    ...
    DWORD   *pcbNew)
{
    ...
    DWORD   cbDT0Offset;
    LPBYTE  lpDst;
    DLGTEMPLATE * lpdt = NULL;
    DLGTEMPLATE2 * lpdt2 = NULL;
    LPBYTE  lpDstOffset;
    LPBYTE  lpSrcOffset;
    DWORD   cbSize;
    int     iCount;
    ...
    BOOL    bDialogEx)
{
    ...
    DLGITEMTEMPLATE * lpdit = NULL;
    DLGITEMTEMPLATE2 * lpdit2 = NULL;
