...
typedef struct midiseqinfo_tag midiseqinfo_tag;
typedef struct midiseqopendesc_tag midiseqopendesc_tag;
...
extern CRITICAL_SECTION SeqCritSec;
...
extern unsigned long mciGetDriverData(unsigned int param_1);

extern unsigned long midiSeqMessage(void *param_1, unsigned int param_2, unsigned long param_3, unsigned long param_4);
extern unsigned long CreateSequence(midiseqopendesc_tag *param_1, void *param_2);
extern unsigned long CnvtTimeFromSeq(SeqStreamType *param_1, unsigned long param_2, midiseqinfo_tag *param_3);
extern unsigned long CnvtTimeToSeq(SeqStreamType *param_1, unsigned long param_2, midiseqinfo_tag *param_3);

extern void EnterCrit(void);
extern void LeaveCrit(void);
extern void Notify(SeqStreamType *param_1, unsigned int param_2);
extern int bMutex(unsigned int param_1, unsigned int param_2, unsigned long param_3, unsigned long param_4, unsigned long param_5);
extern void mciStreamCycle(unsigned long param_1);

PRIVATE HMMIO NEAR PASCAL msOpenFile(LPWSTR szName, LPMMCKINFO lpmmckData, LPMMIOPROC pIOProc);

int __cdecl _DllInstanceInit(void *param_1, unsigned long param_2, void *param_3)
{
    if (param_2 == 1)
    {
        ...
        DisableThreadLibraryCalls((HINSTANCE)param_1);
    }
    else if (param_2 == 0)
    {
...
int DllInstanceInit(HINSTANCE hInstance, ULONG dwReason, void *lpReserved)
{
    if (dwReason == 1)
    {
        _DllMainCRTStartupForGS2(hInstance, 1, lpReserved);
    }
    return _DllInstanceInit(hInstance, dwReason, lpReserved);
}
...
{
#define RMIDFORMTYPE            mmioFOURCC('R', 'I', 'F', 'F')
