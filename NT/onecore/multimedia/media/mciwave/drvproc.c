...
extern STATICDT CRITICAL_SECTION CritSec;

extern INT_PTR CALLBACK ConfigDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam);

int __cdecl _DllInstanceInit(PVOID hModule, ULONG Reason, PCONTEXT pContext)
{
    if (Reason == 1)
    {
