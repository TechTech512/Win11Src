...
// Manual definition of FT_LOGICAL_DISK_TYPE (matches fttypes.h for < Vista)
...
// Manual definition of what we need
...
// Add these declarations before the OpenDevice function
extern "C" {
NTSTATUS NTAPI RtlCreateUnicodeString(PUNICODE_STRING DestinationString, PCWSTR SourceString);
}
