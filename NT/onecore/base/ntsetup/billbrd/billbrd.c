...
SetLayoutParams()
{
    ...
    g_cxLogo = (UINT)(int)(cxScreen * 0.0195);
    g_cyLogo = (UINT)(int) (cyScreen * 0.0053);
    ...
    {
        rcSteps.left    = (UINT)(int) (0.039 * cxScreen);
        rcSteps.top     = (UINT)(int) (0.059 * cyScreen) + g_cyBannerHeight + 
                            g_nTFontHeight + g_nBFontHeight;
        rcSteps.right   = rcSteps.left + (UINT)(int) (0.2005 * cxScreen);
        ...
        iCommentLeft  = rcSteps.left;
        iCommonWidth  = (UINT)(int) (0.1705 * cxScreen);
    ...
    {
        g_cyEstimate    = g_cyStepsHeight + g_cySteps + (UINT)(int) (0.063 * cyScreen);
    }
    ...
    g_cxBillBrdHMargin = (UINT)(int) (cxScreen * 0.06);
