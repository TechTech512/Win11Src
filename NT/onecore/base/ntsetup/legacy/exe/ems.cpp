...
// Define NOTHING macro if it's not defined elsewhere
#ifndef NOTHING
#define NOTHING
#endif
...
--*/
{
    ...
    if (MyString) {
        ...
        if (RetVal != 0) {
            RtlInitUnicodeString(pUnicodeString, (PWSTR)MyString);
            bSuccess = TRUE;
        }
...
--*/
{
    ...
    MaxPasswordLength = (PasswordLength < MY_MAX_PASSWORD_LENGTH) ? PasswordLength : MY_MAX_PASSWORD_LENGTH;
