...
// Forward declarations for types that should be defined elsewhere
typedef struct _SAC_CHANNEL_OPEN_ATTRIBUTES SAC_CHANNEL_OPEN_ATTRIBUTES, *PSAC_CHANNEL_OPEN_ATTRIBUTES;
