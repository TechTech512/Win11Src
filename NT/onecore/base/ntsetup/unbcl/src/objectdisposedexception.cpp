...
class ObjectDisposedException : public SystemException {
public:
    ObjectDisposedException()
        : SystemException() {}

    ObjectDisposedException(const wchar_t* msg)
        : SystemException(msg) {}

    ObjectDisposedException(String* msg)
        : SystemException(msg) {}

    ObjectDisposedException(String* msg, Exception* inner)
