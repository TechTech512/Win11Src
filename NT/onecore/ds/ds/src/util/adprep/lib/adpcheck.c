    ...
    )
{
    ...
    *SchemaVersion = 0;
    ...
    //
    wcscat_s(IniFileName, sizeof(IniFileName)/sizeof(wchar_t), L"\\schema.ini");
...
--*/
{
            ...
            )
    {
        ...
        {
            wcscpy_s(pSchemaMasterReferenceObjDn, 
                     sizeof(pSchemaMasterReferenceObjDn)/sizeof(wchar_t), 
                     *pSchemaValue);
            ...
            {
                wcscpy_s(pDnsHostName, 
                         sizeof(pDnsHostName)/sizeof(wchar_t),  // if it's a static array
                         *pDnsHostNameValue);
